  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[80%] max-h-[80vh] overflow-y-auto bg-[#0F283D] text-white border-[#50adb6]">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-[#50adb6]">Terms of Service</DialogTitle>
          <DialogDescription className="text-white/90">Last updated: February 20, 2024</DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          <section className="space-y-2">
            <h3 className="text-lg font-semibold text-[#50adb6]">1. Acceptance of Terms</h3>
          ...
          <section className="space-y-2">
            <h3 className="text-lg font-semibold text-[#50adb6]">2. Use License</h3>
            <p className="text-white/80 leading-relaxed">
          ...
          <section className="space-y-2">
            <h3 className="text-lg font-semibold text-[#50adb6]">3. Disclaimer</h3>
            <p className="text-white/80 leading-relaxed">
          ...
          <section className="space-y-2">
            <h3 className="text-lg font-semibold text-[#50adb6]">4. Limitations</h3>
            <p className="text-white/80 leading-relaxed">
